...
const Header = () => {
  ...
  return (
    <>
      <header
        className="siteHeader py-2 sticky-top"
          ...
          <nav className="d-flex align-items-center justify-content-between gap-10">
            ...
            <div className="right d-flex align-items-center justify-content-end gap-10">
              <div className={`sidebar ${sidebar && "active"}`}>
                <Button
                  variant="transparent"
                  className="border-0 d-lg-none p-0 position-absolute closeBtn"
                  onClick={handleClick}
                >
                  <svg
                ...
                <ul
                  className={
                    "list-unstyled ps-0 mb-0 d-flex align-items-center justify-content-end gap-10"
                  }
                >
                  ...
                  <li className="">
                    <Button
                      className="d-flex align-items-center justify-content-center gap-10 gradientBtn"
                      onClick={handleClick}
                    >
                      <span className="icn">
                        <svg
              ...
              >
                ...
                >
                  <path
                    d="M3 3H48.0077M3 18H48.0077M3 33H48.0077"
                    stroke="white"
                    strokeWidth="5"
                    strokeLinecap="round"
                  />
