  ...
  return (
    <div className='nextCircle sliksarrow' style={{ ...style, display: "block" }} onClick={onClick}>
      <svg width="60" height="60" viewBox="0 0 60 60" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path fill-rule="evenodd" clip-rule="evenodd" d="M30 60C13.4315 60 0 46.5685 0 30C0 13.4315 13.4315 0 30 0C46.5685 0 60 13.4315 60 30C60 46.5685 46.5685 60 30 60ZM22.8122 17.2902C21.5474 16.2199 21.3896 14.327 22.4598 13.0622C23.5301 11.7974 25.423 11.6396 26.6878 12.7098L42.6956 26.2549C45.2073 28.38
